...
@click.option('--heavy-v-germline', required=False, default="auto", type=str, help='Germline heavy V gene to use as template for humanization. Use Auto to pick nearest germline based on sequence homology.')
@click.option('--light-v-germline', required=False, default="auto", type=str, help='Germline light V gene to use as template for humanization. Use Auto to pick nearest germline based on sequence homology.')
